...
--[dbo].[Focas_PushTempToHistory] 'ACE-01','OffsetHistory'
...
Select #MO.Machineid,#MO.[ProgramNo],#MO.[OffsetNo],#MO.[WearOffsetX],#MO.[WearOffsetZ],#MO.[WearOffsetR],#MO.[WearOffsetT],#MO.[CNCTimeStamp],#MO.[MachineMode],#MO.[ToolNo] from [dbo].[Focas_ToolOffsetHistoryTemp] #MO
