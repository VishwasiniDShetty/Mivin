/****** Object:  Procedure [dbo].[s_GetShiftwiseProductionReportFromAutodata]    Committed by VersionSQL https://www.versionsql.com ******/
...
s_GetShiftwiseProductionReportFromAutodata '2020-11-02','','Equator Phantom','','','','','2020-11-02','shift'
s_GetShiftwiseProductionReportFromAutodata '2020-11-02','','Laser Marking Machine Compact x','','','','','2020-11-03','shift'


**************************************************************************************************/
----s_GetShiftwiseProductionReportFromAutodata '2012-08-01','','IMPELLER OP 10 B','','','','2012-08-02','Shift_UT_DT'
----s_GetShiftwiseProductionReportFromAutodata '2019-07-02','','','','','','2019-07-02','shift'
----s_GetShiftwiseProductionReportFromAutodata '2019-07-10','','','','','','2019-07-10','ProdandDown'
----s_GetShiftwiseProductionReportFromAutodata '2019-05-01 07:00:00','','','','','','2021-05-15 07:00:00',''
CREATE PROCEDURE [dbo].[s_GetShiftwiseProductionReportFromAutodata]
	@StartDate datetime,
	@ShiftIn nvarchar(20) = '',
...
---------------------------------by Mrudula for optimization------------------------------------
	print sysdatetime()
		...
		--ER0324 Added Till Here
		 ...
		 print sysdatetime()
		Select @strsql=''
		select @strsql ='insert into #Machcomopnopr(Machine,GroupID,MachineInt,MachineDescription,Component,CompInt,Operation,OpnInt,Operator,Shdate,
		...
		select @strsql = @strsql + 'SELECT distinct  Machineinformation.Machineid,PlantMachineGroups.GroupID,Machineinformation.interfaceid,Machineinformation.Description,
						...
						componentoperationpricing.interfaceid,Employeeinformation.Employeeid, Pdate, Shift, ShiftStart, ShiftEnd '
...
select @strsql = @strsql + ' SELECT distinct  S.MachineID as Mach,S.Component as Compn,S.Operation as Oprn,'
		...
		Select @strsql=''
		*/
		 Print  '----insert into #ShiftProductionFromAutodataT2------'
         print getdate() 
		...
		INSERT INTO #ShiftProductionFromAutodataT1 (
		 MachineID ,GroupID,OperatorID,MachineInterface,MachineDescription,ProductionEfficiency ,AvailabilityEfficiency ,
		OverallEfficiency ,UtilisedTime ,ManagementLoss,DownTime ,CN,Udate,Ushift,UstartShift,UEndShift)
		
		SELECT DISTINCT Machine ,GroupID,0,MachineInt,MachineDescription,0,0,0,0,0,0,0,Shdate,
