/****** Object:  Procedure [dbo].[s_GetTurnOver_CustomerWise]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE s_GetTurnOver_CustomerWise
...
select @strsql = @strsql + ' SELECT  workorderheader.customerid as CustomerID,'
...
select @strsql = @strsql + ' GROUP BY workorderheader.customerid'
exec (@strsql)
--print @strsql
/*
SELECT  workorderheader.customerid as CustomerID,
...
GROUP BY workorderheader.customerid
*/
END
