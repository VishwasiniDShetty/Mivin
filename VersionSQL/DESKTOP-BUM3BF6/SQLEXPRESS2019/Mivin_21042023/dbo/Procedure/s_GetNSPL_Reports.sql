...
inner join employeeinformation  on employeeinformation.interfaceid=#T_Autodata.opr left outer join PlantMachine P on
machineinformation.machineid = P.MachineID ' --ER0434
...
Select [Date],ShiftNAME,Machine,Operator,Component,Operation,RowHeader1,RowHeader2,RowHeader3,IsNull(RowValue,0) as RowValue from #FINALOUTPUT
