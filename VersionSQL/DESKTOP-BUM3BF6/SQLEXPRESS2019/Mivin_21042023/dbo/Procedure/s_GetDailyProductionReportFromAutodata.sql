/****** Object:  Procedure [dbo].[s_GetDailyProductionReportFromAutodata]    Committed by VersionSQL https://www.versionsql.com ******/
...
--s_GetDailyProductionReportFromAutodata '2019-07-01','','Phantom','','','','2021-07-01'

[dbo].[s_GetDailyProductionReportFromAutodata] '2020-11-02','Equator Phantom','','','','','2020-11-02'
[dbo].[s_GetDailyProductionReportFromAutodata] '2020-11-02','Laser Marking Machine Compact x','','','','','2020-11-02'
[dbo].[s_GetDailyProductionReportFromAutodata] '2020-11-19','TURNING-07','','','','','2020-11-22'

**************************************************************************************************************/
CREATE PROCEDURE [dbo].[s_GetDailyProductionReportFromAutodata]
	@StartDate datetime,
...
--s_GetDailyProductionReportFromAutodata '2009-12-01','','','','','2009-12-02'MCV 500
End
...
select  #DailyProductionFromAutodataT1.MachineID,
	...
	ROUND(#DailyProductionFromAutodataT1.ProductionEfficiency,2) as ProductionEfficiency,
	ROUND(#DailyProductionFromAutodataT1.AvailabilityEfficiency,2) as AvailabilityEfficiency,
	...
	ROUND(#DailyProductionFromAutodataT1.OverallEfficiency,2) as OverallEfficiency,
