...
/*
exec s_GetProductionandDowntimeDetails '2019-10-01 06:00:00','2019-10-02 06:00:00','J-125','','Summary'
exec s_GetProductionandDowntimeDetails '2019-10-01 06:00:00','2019-10-02 06:00:00','J-125','','COLevelDetails'
exec s_GetProductionandDowntimeDetails '2019-10-01 06:00:00','2019-10-02 06:00:00','J-125','','Efficiency'
exec s_GetProductionandDowntimeDetails '2019-10-01 06:00:00','2019-10-02 06:00:00','J-125','','Inprocessprodcycle'
exec s_GetProductionandDowntimeDetails '2019-10-01 06:00:00','2019-10-02 06:00:00','J-125','','Inprocessdowncycles'
exec s_GetProductionandDowntimeDetails '2019-10-01 06:00:00','2019-10-02 06:00:00','J-125','','DowntimeSummary'
*/
...
Begin
	...
	Begin
		...
		Select Machineid,DownDescription,dbo.f_FormatTime(SUM(cast(DownTime as float)), @TimeFormat) as DownTime,COUNT(DownID) as NoOfOccurences
		...
		select Machineid,DownDescription,DownTime,NoOfOccurences,dbo.f_FormatTime(MinDowntime,@TimeFormat) as MinDowntime,
		dbo.f_FormatTime(MaxDowntime,@TimeFormat) as MaxDowntime from #DowntimeSummary order by Machineid	
		RETURN
	END
	...
	Begin
		...
		dbo.f_formattime((Totaltime-PDT-(Downtime+Managementloss)),'hh:mm:ss') as Runtime,
		--Isnull(Round((UtilisedTime/CASE when Totaltime=0 then 1 else Totaltime END) * 100,2),0) as RuntimeEffy,
		Isnull(Round(((Totaltime-PDT-(Downtime+Managementloss))/CASE when Totaltime=0 then 1 else (Totaltime-(Managementloss+PDT)) END) * 100,2),0) as RuntimeEffy,
