...
[dbo].[s_Push_Prodn_Down_ShiftAggregation] '2021-04-30 15:00:00.000','','''VMC-17''','','PUSH','','2021-05-02 01:00:00.000',''
*****************************************************************************************************************/
...
select @strsql = @strsql + 'SELECT mc, comp, opn, opr, dcode,sttime,'  
 select @strsql = @strsql + 'ndtime, datatype, cycletime, loadunload, msttime, PartsCount,id,''0'''  
...
,FormatedWONumber,GroupID,mchrrate)' --ER0349 added New Column --GNA
--DR0272 Till Here
---mod 7
...
---mod 7
SELECT @StrSql= @StrSql+',A.WorkOrderNumber,PlantMachineGroups.GroupID, machineinformation.mchrrate ' --ER0349 Added --GNA
SELECT @StrSql= @StrSql
...
---mod 7
SELECT @StrSql = @StrSql + ',A.WorkOrderNumber,machineinformation.MachinewiseOwner ,machineinformation.CriticalMachineEnabled,PlantMachineGroups.GroupID, machineinformation.mchrrate '--geeta added --GNA
---mod 7
print @StrSql
Exec (@StrSql)
...
else T.MinLoadUnloadTime end as MinLoad,ISNULL(T.PDT,0) as PDT from #TempShiftProductionDetails T
...
---mod 7
,MachinewiseOwner ,CriticalMachineEnabled,GroupID,mchrrate,PDT)--geeta added --GNA
