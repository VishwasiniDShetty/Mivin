...
--s_PMT_GetProductionAndDownReport '2019-06-05','','','',''
...
from
(Select Machine,shiftstart,SUM(datediff(SECOND,Starttime,endtime))as PDT from Planneddowntimes
...
where starttime>=#ProdData.shiftstart and endtime<=#ProdData.shiftend group by Machine,shiftstart)T1
