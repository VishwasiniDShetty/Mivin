...
If  @tp='1' or @tp='2' OR @tp = '42' OR @tp = '11' OR  @tp = '22' or @tp='44'or @tp=20 -- ER0094  
BEGIN
...
--mod 6  
 ...
 ---(@tp_int,@IpAddress,@McInterfaceID,@component,@operation,@operator,@PalletCount, @startdate+ ' ' + @starttime,@enddate+ ' ' + @endtime,@SubdataString,0) 
   ...
   Insert into Rawdata(datatype,IPAddress,Mc,Comp,Opn,Opr,SPLSTRING1,Sttime,Ndtime,SPLSTRING2,Status,WorkOrderNumber)values  
        (@tp_int,@IpAddress,@McInterfaceID,@component,@operation,@operator,@PalletCount, @startdate+ ' ' + @starttime,@enddate+ ' ' + @endtime,@SubdataString,0,@WorkOrder)  
  ---mod 5  
  ---mod 6 
...
--   return  
 ...
 BEGIN  
--set @Slno_Rdata=''  
--set @Slno_Rdata=@@identity--(convert(char(50),@Slno_Rdata)  
--print @Slno_Rdata  
--return  
  ---mod 5: Insert workOrderNumber also in rawdata  
  ...
  Insert into Rawdata(datatype,IPAddress,Mc,Comp,Opn,Opr,Sttime,Ndtime,SPLSTRING2,Status,WorkOrderNumber)values  
  (@tp_int,@IpAddress,@McInterfaceID,@component,@operation,@operator, @startdate+ ' ' + @starttime,@enddate+ ' ' + @endtime,@downcode,0,@WorkOrder)  
  ---mod 5  
--SK  
--  set @Slno_Rdata=''  
...
---   s_GetProcessDataString 'START-31-0001-00000456-01-0123-[13.5000]-[13.60]-008-[89]-[650]-20210127-122728817-END','127.0.0.1','','33'  
---   s_GetProcessDataString 'START-31-0001-00000456-01-0123-[13.5000]-[13.60]-008-[89]-[650]-20210127-122728817-abc-I1-END','127.0.0.1','','33'  
...
End 
  ...
  If (IsDate(@startdate + ' ' + @starttime) = 1)  
  BEGIN  
   Insert into Rawdata(datatype,IPAddress,Mc,Comp,Opn,Opr,SPLSTRING3,Sttime,SPLSTRING2,Status,SPLSTRING4,SPLSTRING5,SPLSTRING6,SPLString7,SPLString8)values  
   (@tp_int,@IpAddress,@McInterfaceID,@component,@operation,@operator,@Dimension,@startdate+ ' ' + @starttime,@DimValue,0,@WearOffSetNumber,@MeasureDimension,@CorrectionValue,@Remarks,@InspectionType)  
  END  
