/****** Object:  Procedure [dbo].[s_GetInProcessCycles_eshopx]    Committed by VersionSQL https://www.versionsql.com ******/
...
CREATE      PROCEDURE [dbo].[s_GetInProcessCycles_eshopx]
	@StartTime datetime,
	@EndTime datetime,
...
(componentoperationpricing.machiningTime) as stdMcTime,
(componentoperationpricing.cycletime - componentoperationpricing.machiningtime) as stdlLoadUnloadTime
...
--select ComponentID,description,OperationNo,OperatorID,OperatorName,sttime,ndtime,CycleTime,mc,comp,opn,PDT,LoadUnloadTime,Remarks,StdCycleTime,StdMachiningTime,id,In_Cycle_DownTime,stdmctime,stdlLoadUnloadTime from #Temp --ER0350
select ComponentID,description,OperationNo,OperatorID,OperatorName,sttime,ndtime,CycleTime,mc,comp,opn,PDT,LoadUnloadTime,Remarks,StdCycleTime,StdMachiningTime,id,In_Cycle_DownTime,stdmctime,stdlLoadUnloadTime,0 from #Temp --ER0350
where datatype=11
