...
/***********************************************************************************
s_GetHourlyTarget_Count_followup_AtLineLevel '2016-02-10','CNC VTL','second','','','RunningPart'
s_GetHourlyTarget_Count_followup_AtLineLevel '2017-01-15','','','','','BOSCH_BNG_CamShaft'
s_GetHourlyTarget_Count_followup_AtLineLevel '2017-01-15','','','','','BOSCH_BNG_CamShaftsummary'
s_GetHourlyTarget_Count_followup_AtLineLevel '2017-01-15','','','','','BOSCH_Nashik_AELosses'
***********************************************************************************/
...
--	from #ShiftTemp where Machinedescription like ('KM A/F MILLING') group by Machineid,PDate,ShiftName,ShiftID
	...
	select PlantMachineGroups.GroupID,S.Machineid,S.PDate,S.ShiftName,S.ShiftID,sum(S.Target),sum(S.Actual)
	from #ShiftTemp S 
	inner join Machineinformation on Machineinformation.Machineid=S.Machineid
	inner join PlantMachine on PlantMachine.Machineid=Machineinformation.Machineid
	Left Outer Join PlantMachineGroups on S.machineID=PlantMachineGroups.machineID WHERE 1=1 '
