...
s_GetHourlyTarget_Count_followup '2017-01-14','2017-01-14','CNC GRINDING','','BOSCH_Nashik_AELosses' --Pass Same day    
***********************************************************************************/    
...
Begin    
 Select machineID,MachineInterface,pDate,HourID,ShiftID,FromTime,ToTime,T.Catagory as Downcategory,T.Downid as Downid,T.interfaceid as interfaceid,0 as DownTime into #AE_Losses1    
