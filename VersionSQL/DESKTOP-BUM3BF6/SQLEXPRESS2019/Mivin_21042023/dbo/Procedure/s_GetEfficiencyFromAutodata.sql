/****** Object:  Procedure [dbo].[s_GetEfficiencyFromAutodata]    Committed by VersionSQL https://www.versionsql.com ******/
...
*******************************************************************************************************/
--s_GetEfficiencyFromAutodata '2018-11-01','2019-03-09','','','','Shift','','Console'
-- s_GetEfficiencyFromAutodata	'2018-11-22','2019-03-23','','','','Shift','','Console'



CREATE            PROCEDURE [dbo].[s_GetEfficiencyFromAutodata]
	@StartTime datetime ,
	@EndTime datetime ,
...
SET @strSql = 'INSERT INTO #CockpitData (
			...
			SET @strSql = @strSql + ' SELECT S.Pdate,S.FromTime,S.ToTime,S.ShiftName,MachineInformation.MachineID, MachineInformation.interfaceid ,0,0,0,0,0,0,0,0,0 FROM MachineInformation
