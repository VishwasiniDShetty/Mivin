...
--[s_GetKunAero_DailyProductionReportFromAutodata] '2017-11-15','','',''
...
Select @strsql=''   
Select @strsql= 'insert into #Target(MachineID,MachineInterface,Component,CompInterface,Compdescription,CustomerName,Operation,OpnInterface,WorkOrderNo,Stdmctime,StdCycletime,StdLoadunload,Suboperations,TargetPercent,msttime,ndtime,
...
componentinformation.description,componentinformation.customerid,componentoperationpricing.operationno, componentoperationpricing.interfaceid,autodata.WorkorderNumber,  
...
insert into #FinalTarget (MachineID,MachineInterface,Component,CompInterface,Compdescription,CustomerName,Operation,OpnInterface,WorkOrderNo,StdMctime,StdCycletime,StdLoadunload,Suboperations,TargetPercent,msttime,ndtime,batchid,Pdate,Shift,FromTm,ToTm)
select MachineID,MachineInterface,Component,CompInterface,Compdescription,CustomerName,Operation,OpnInterface,WorkOrderNo,StdMctime,StdCycletime,StdLoadunload,Suboperations,TargetPercent,min(msttime),max(ndtime),batchid,Pdate,Shift,FromTm,ToTm
from
(
select MachineID,MachineInterface,Component,CompInterface,Compdescription,CustomerName,Operation,OpnInterface,WorkOrderNo,StdMctime,StdCycletime,StdLoadunload,Suboperations,TargetPercent,msttime,ndtime,Pdate,Shift,FromTm,ToTm,
RANK() OVER (
...
group by  MachineID,MachineInterface,Component,CompInterface,Compdescription,CustomerName,Operation,OpnInterface,WorkOrderNo,StdMctime,StdCycletime,StdLoadunload,Suboperations,TargetPercent,batchid,Pdate,Shift,FromTm,ToTm
order by tt.batchid
...
SELECT F.machineinterface,F.Compinterface,F.Opninterface,F.Workorderno,F.FromTm,
 ...
 insert into #Finaltarget1(MachineID,MachineInterface,component,CompInterface,Operation,OpnInterface,WorkOrderNo,StdMctime,StdLoadunload,StdCycletime,Suboperations,Compdescription,CustomerName,Targetpercent)
 Select MachineID,MachineInterface,component,CompInterface,Operation,OpnInterface,WorkOrderNo,StdMctime,StdLoadunload,StdCycletime,Suboperations,Compdescription,CustomerName,Targetpercent from #Finaltarget
 group by  MachineID,MachineInterface,component,CompInterface,Operation,OpnInterface,WorkOrderNo,StdMctime,StdLoadunload,StdCycletime,Suboperations,Compdescription,CustomerName,Targetpercent

 update #FinalTarget1 set Shift1PlanQty=T2.planqty,Shift1Accepted=ISNULL(T2.Accepted,0)-ISNULL(T2.Rejected,0),Shift1Rejected=T2.Rejected,Shift1Downtime=T2.Downtime,Shift1Operatorname=T2.Operatorname from
 ...
 SUM(Downtime) as Downtime,Operatorname from (select * from #FinalTarget where shiftid='1')#FinalTarget
 group by MachineInterface,CompInterface,OpnInterface,WorkOrderNo,Operatorname) as T2 INNER JOIN #FinalTarget1 on t2.machineinterface = #FinalTarget1.machineinterface and  
 t2.compinterface = #FinalTarget1.compinterface and t2.opninterface = #FinalTarget1.opninterface and  t2.Workorderno = #FinalTarget1.Workorderno 
  ...
  update #FinalTarget1 set Shift2PlanQty=T2.planqty,Shift2Accepted=ISNULL(T2.Accepted,0)-ISNULL(T2.Rejected,0),Shift2Rejected=T2.Rejected,Shift2Downtime=T2.Downtime,Shift2Operatorname=T2.Operatorname from
 (select MachineInterface,CompInterface,OpnInterface,WorkOrderNo,ISNULL(sum(PlanQty),0) as planqty,ISNULL(SUM(Accepted),0) as Accepted,ISNULL(SUM(Rejected),0) as Rejected,
 SUM(Downtime) as Downtime,Operatorname from (select * from #FinalTarget where shiftid='2')#FinalTarget 
 group by MachineInterface,CompInterface,OpnInterface,WorkOrderNo,Operatorname) as T2 INNER JOIN #FinalTarget1 on t2.machineinterface = #FinalTarget1.machineinterface and  
 t2.compinterface = #FinalTarget1.compinterface and t2.opninterface = #FinalTarget1.opninterface and  t2.Workorderno = #FinalTarget1.Workorderno 

  update #FinalTarget1 set Shift3PlanQty=T2.planqty,Shift3Accepted=ISNULL(T2.Accepted,0)-ISNULL(T2.Rejected,0),Shift3Rejected=T2.Rejected,Shift3Downtime=T2.Downtime,Shift3Operatorname=T2.Operatorname from
 (select MachineInterface,CompInterface,OpnInterface,WorkOrderNo,ISNULL(sum(PlanQty),0) as planqty,ISNULL(SUM(Accepted),0) as Accepted,ISNULL(SUM(Rejected),0) as Rejected,
 SUM(Downtime) as Downtime,Operatorname from (select * from #FinalTarget where shiftid='3')#FinalTarget
 group by MachineInterface,CompInterface,OpnInterface,WorkOrderNo,Operatorname) as T2 INNER JOIN #FinalTarget1 on t2.machineinterface = #FinalTarget1.machineinterface and  
 t2.compinterface = #FinalTarget1.compinterface and t2.opninterface = #FinalTarget1.opninterface and  t2.Workorderno = #FinalTarget1.Workorderno 
...
update #FinalTarget1 set Shift1AcceptPercent = (Shift1Accepted/Shift1PlanQty)*100  where Shift1PlanQty>0

update #FinalTarget1 set Shift1Rejectpercent = (Shift1Rejected/Shift1PlanQty)*100  where Shift1PlanQty>0

update #FinalTarget1 set Shift2AcceptPercent = (Shift2Accepted/Shift2PlanQty)*100  where Shift2PlanQty>0

update #FinalTarget1 set Shift2Rejectpercent = (Shift2Rejected/Shift2PlanQty)*100  where Shift2PlanQty>0

update #FinalTarget1 set Shift3AcceptPercent = (Shift3Accepted/Shift3PlanQty)*100  where Shift3PlanQty>0

update #FinalTarget1 set Shift3Rejectpercent = (Shift3Rejected/Shift3PlanQty)*100  where Shift3PlanQty>0
...
'' as Remarks1,Shift1Operatorname,
...
'' as Remarks2,Shift2Operatorname,
...
'' as Remarks3,Shift3Operatorname,
ISNULL(ProdTotal,0) as ProdTotal,ISNULL(CumulativeProdTotal,0) as CumulativeProdTotal,isnull(WorkingHrs,0) AS WorkingHrs,
