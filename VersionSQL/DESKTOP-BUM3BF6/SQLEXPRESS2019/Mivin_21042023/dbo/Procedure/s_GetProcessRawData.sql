...
---mod 4
	...
	DECLARE SD_CUR CURSOR FOR SELECT Slno,DataType,IPAddress,Mc,Comp,Opn,Opr,Splstring1,Sttime,Ndtime,SplString2,Status,WorkOrderNo,Splstring3,Splstring4,Splstring5,Splstring6,Splstring7,Splstring8  FROM #SD_RawData
	---mod 10
	OPEN SD_CUR
	...
	FETCH NEXT FROM SD_CUR INTO @Slno,@DataType,@IPAddress, @Mc,@Comp,@Opn,@Opr,@Splstring1,@Sttime,@Ndtime,@SplString2,@Status,@WorkOrderNo,@Splstring3,@WearOffSetNumber,@MeasureDimension,@CorrectionValue,@InspectionType,@Remarks
	---mod 10
	--process in loop
...
*/
			   ...
			   --if @Act_LoadUnload<=5 and (datediff(ss,@LastStarttime,@TempNdTime)-@TpmStdLoadunload)>0 and ((Select count(*) from autodata where mc=@mc and sttime=@LastStarttime and datatype=2)=1) --ER0497 Commented
				...
				BEGIN
						...
						BEGIN
		        			...
		        			@TempNdTime ,Datename(year,@Sttime) + '-' + Datename(month,@Sttime) + '-' + Datename(day,@Sttime),@Sttime,0,DATEDIFF(ss,@TempNdTime,@Sttime),@TempNdTime,@WorkOrderNo)
			  ...
			  BEGIN TRANSACTION
		      	      Insert into autodata (datatype,mc,comp,opn,opr,dcode,stdate,sttime,nddate,ndtime,cycletime,loadunload,msttime,WorkOrderNumber) values
	             		(2,@Mc ,@Comp ,@Opn ,@Opr ,'NO_DATA',Datename(year,@Sttime) + '-' + Datename(month,@Sttime) + '-' + Datename(day,@Sttime) ,Datename(year,@Sttime) + '-' + Datename(month,@Sttime) + '-' + Datename(day,@Sttime) + ' 00:00:00',Datename(year,@Sttime) + '-' + Datename(month,@Sttime) + '-' + Datename(day,@Sttime),
			              DATEADD(ss,-@Std_LoadUnload,@Sttime) ,0, (DateDiff(s, Datename(year,@Sttime) + '-' + Datename(month,@Sttime) + '-' + Datename(day,@Sttime) + ' 00:00:00', @Sttime)-@Std_LoadUnload) ,Datename(year,@Sttime) + '-' + Datename(month,@Sttime) + '-' + Datename(day,@Sttime) + ' 00:00:00',@WorkOrderNo)
		...
		--mod 22
		 ...
		 If  (Select [NPCy-Tcs] from autodata_maxtime where [NPCy-Tcs]>=@Sttime and [NPCy-Tcs]<=@Ndtime) <> ''
		  Begin
			...
			Insert into autodata (datatype,mc,comp,opn,opr,dcode,stdate,sttime,nddate,ndtime,cycletime,loadunload,msttime,workordernumber) values
				 (2,@Mc ,@Comp ,@Opn ,@Opr ,'NPCy',DateName(year,@Sttime)+ '-' +  DateName(month,@Sttime)+ '-' + DateName(day,@Sttime) ,
		        	  @Sttime ,Datename(year,@Ndtime) + '-' + Datename(month,@Ndtime) + '-' + Datename(day,@Ndtime),@Ndtime,0,datediff(s,@Sttime,@Ndtime),@Sttime,@WorkOrderNo)
			---mod 10
			SET @Error = @@ERROR
			IF @Error <> 0 GOTO ERROR_HANDLER_FOR_ALLTYPES
			  While @@TRANCOUNT <> 0
		...
		BEGIN
				...
				begin
					...
					values (2, @Mc , @Comp , @Opn , @Opr , 'Dummy Cycle' ,DateName(year,@Sttime)+ '-' +DateName(month,@Sttime)+ '-' + DateName(day,@Sttime),@Sttime,DateName(year,@Ndtime)+ '-' +DateName(month,@Ndtime)+ '-' + DateName(day,@Ndtime),@Ndtime,0, DateDiff(second, @Sttime, @Ndtime) ,@Sttime,@WorkOrderNo)
				...
				begin
					...
					insert into autodata (datatype,mc,comp,opn,opr,dcode,stdate,sttime,nddate,ndtime,cycletime,loadunload,msttime,WorkOrderNumber)
					values (2, @Mc , @Comp , @Opn , @Opr , 'Dry Cycle' ,DateName(year,@Sttime)+ '-' +DateName(month,@Sttime)+ '-' + DateName(day,@Sttime),@Sttime,DateName(year,@Ndtime)+ '-' +DateName(month,@Ndtime)+ '-' + DateName(day,@Ndtime),@Ndtime,0, DateDiff(second, @Sttime, @Ndtime) ,@Sttime,@WorkOrderNo)
		...
		BEGIN
				...
				Begin
					IF (DateDiff(second, @Sttime, @Ndtime)<=@SCIThreshold )  and @SCIThreshold > 0.0
						...
						begin
							...
							insert into autodata (datatype,mc,comp,opn,opr,dcode,stdate,sttime,nddate,ndtime,cycletime,loadunload,msttime,WorkOrderNumber)
							values (2, @Mc , @Comp , @Opn , @Opr , 'SCILU' ,DateName(year,DateAdd(second,-@Act_LoadUnload,@Sttime))+ '-' +DateName(month,DateAdd(second,-@Act_LoadUnload,@Sttime))+ '-' + DateName(day,DateAdd(second,-@Act_LoadUnload,@Sttime)),DateAdd(second,-@Act_LoadUnload,@Sttime),DateName(year,@Sttime)+ '-' +DateName(month,@Sttime)+ '-' + DateName(day,@Sttime),@Sttime,0,@Act_LoadUnload ,DateAdd(second,-@Act_LoadUnload,@Sttime),@WorkOrderNo)
						...
						begin
							...
							insert into autodata (datatype,mc,comp,opn,opr,dcode,stdate,sttime,nddate,ndtime,cycletime,loadunload,msttime,WorkOrderNumber)
							values (2, @Mc , @Comp , @Opn , @Opr , 'SCI' ,DateName(year,@Sttime)+ '-' +DateName(month,@Sttime)+ '-' + DateName(day,@Sttime),@Sttime,DateName(year,@Ndtime)+ '-' +DateName(month,@Ndtime)+ '-' + DateName(day,@Ndtime),@Ndtime,0, DateDiff(second, @Sttime, @Ndtime) ,@Sttime,@WorkOrderNo)
						...
						insert into autodata (datatype,mc,comp,opn,opr,dcode,stdate,sttime,nddate,ndtime,cycletime,loadunload,msttime,WorkOrderNumber)
						values (2, @Mc , @Comp , @Opn , @Opr , 'DCL' ,DateName(year,@Sttime)+ '-' +DateName(month,@Sttime)+ '-' + DateName(day,@Sttime),@Sttime,DateName(year,@Ndtime)+ '-' +DateName(month,@Ndtime)+ '-' + DateName(day,@Ndtime),@Ndtime,0, DateDiff(second, @Sttime, @Ndtime) ,@Sttime,@WorkOrderNo)
			...
			---Look for datatype 42 records in Autodata_ICD table within starttime and endtime for the cycle.
				...
				BEGIN
					...
					Insert into autodata (datatype,mc,comp,opn,opr,stdate,sttime,nddate,ndtime,cycletime,loadunload,msttime,PartsCount,WorkOrderNumber) values
				             (@Datatype,@Mc , @Comp , @Opn, @Opr,Datename(year,@Sttime) + '-' + Datename(month,@Sttime) + '-' + Datename(day,@Sttime),@Sttime,Datename(year,@Ndtime) + '-' + Datename(month,@Ndtime) + '-' +Datename(day,@Ndtime),@Ndtime, DateDiff(second, @Sttime, @Ndtime) - @TotalDown ,@Act_LoadUnload ,DateAdd(second,-@Act_LoadUnload,@Sttime),@SplString1,@WorkOrderNo)
					---mod 10
			     ...
			     BEGIN
				   --INSERT PRODUCTION RECORD
					...
					--(@DataType,@Mc ,@Comp ,@Opn ,@Opr ,Datename(year,@Sttime) + '-' + Datename(month,@Sttime) + '-' + Datename(day,@Sttime),@Sttime,Datename(year,@Ndtime) + '-' + Datename(month,@Ndtime) + '-' +Datename(day,@Ndtime),@Ndtime,@MachiningTime,@Act_LoadUnload ,DateAdd(second,-@Act_LoadUnload,@Sttime),@SplString1)
				     Insert into autodata (datatype,mc,comp,opn,opr,stdate,sttime,nddate,ndtime,cycletime,loadunload,msttime,PartsCount,WorkOrderNumber) values
						(@DataType,@Mc ,@Comp ,@Opn ,@Opr ,Datename(year,@Sttime) + '-' + Datename(month,@Sttime) + '-' + Datename(day,@Sttime),@Sttime,Datename(year,@Ndtime) + '-' + Datename(month,@Ndtime) + '-' +Datename(day,@Ndtime),@Ndtime,@MachiningTime,@Act_LoadUnload ,DateAdd(second,-@Act_LoadUnload,@Sttime),@SplString1,@WorkOrderNo)
				    --mod 10
			 ...
			 Else
			      BEGIN
				     ...
				     ---mod 10:insert work order number also.@WorkOrderNo
				      ...
				      Insert into autodata (datatype,mc,comp,opn,opr,stdate,sttime,nddate,ndtime,cycletime,loadunload,msttime,PartsCount,workordernumber) values
						(@DataType,@Mc ,@Comp ,@Opn ,@Opr ,Datename(year,@Sttime) + '-' + Datename(month,@Sttime) + '-' + Datename(day,@Sttime),@Sttime,Datename(year,@Ndtime) + '-' + Datename(month,@Ndtime) + '-' +Datename(day,@Ndtime),@Ndtime, DateDiff(second, @Sttime, @Ndtime),@Act_LoadUnload ,DateAdd(second,-@Act_LoadUnload,@Sttime),@SplString1,@WorkOrderNo )
				     ---mod 10
			...
			SET @Act_LoadUnload=@LUforPrNxtToNODATA
				  ...
				  Begin
					...
					WHILE @i <=  @Splstring1
					 BEGIN
						...
						insert into autodata (datatype,mc,comp,opn,opr,stdate,sttime,nddate,ndtime,cycletime,loadunload,msttime,PartsCount,workordernumber) values
							(@DataType,@Mc ,@Comp ,@Opn ,@Opr ,Datename(year,@sttime) + '-' + Datename(month,@sttime) + '-' + Datename(day,@sttime),@sttime,Datename(year,@ndtime) + '-' + Datename(month,@ndtime) + '-' +Datename(day,@ndtime),@ndtime,DateDiff(second, @sttime,@ndtime),@Act_LoadUnload ,DateAdd(second,-@Act_LoadUnload,@dtStartTime),1,@WorkOrderNo)
						--mod 10
						SET @Error = @@ERROR
						IF @Error <> 0 GOTO ERROR_HANDLER_FOR_ALLTYPES
			     			SET @sttime = @ndtime
			  ...
			  Else	
				...
				BEGIN
					...
					insert into autodata (datatype,mc,comp,opn,opr,stdate,sttime,nddate,ndtime,cycletime,loadunload,msttime,PartsCount,workordernumber) values
						(@DataType,@Mc ,@Comp ,@Opn ,@Opr ,Datename(year,@sttime) + '-' + Datename(month,@sttime) + '-' + Datename(day,@sttime),@sttime,Datename(year,@ndtime) + '-' + Datename(month,@ndtime) + '-' +Datename(day,@ndtime),@ndtime,DateDiff(second, @sttime,@ndtime),@Act_LoadUnload ,DateAdd(second,-@Act_LoadUnload,@dtStartTime),1,@WorkOrderNo) --dr0119
					---mod 10
					SET @Error = @@ERROR
					IF @Error <> 0 GOTO ERROR_HANDLER_FOR_ALLTYPES
			     		SET @sttime = @ndtime
				...
				If (DateDiff(second, @sttime, @ndtime) > @MachiningTimeThreshold) and (@MachiningTimeThreshold>60) AND ( @OrgMachiningTimeThreshold > 0.0) 
				  begin
						...
						BEGIN
							...
							(@Datatype,@Mc ,@Comp ,@Opn ,@Opr ,Datename(year,@sttime) + '-' + Datename(month,@sttime) + '-' + Datename(day,@sttime),@sttime,Datename(year,@ndtime) + '-' + Datename(month,@ndtime) + '-' +Datename(day,@ndtime),@ndtime,@MachiningTime,@Act_LoadUnload ,DateAdd(ms,-(@Act_LoadUnload*1000),@dtStartTime),1,@WorkOrderNo) --ER0371
						   	---mod 10
				  ...
				  Begin
					...
					BEGIN
					   ...
					   -- (@Datatype,@Mc ,@Comp ,@Opn ,@Opr ,Datename(year,@sttime) + '-' + Datename(month,@sttime) + '-' + Datename(day,@sttime),@sttime,Datename(year,@ndtime) + '-' + Datename(month,@ndtime) + '-' +Datename(day,@ndtime),@ndtime,DateDiff(second, @sttime,@ndtime),@Act_LoadUnload ,DateAdd(second,-@Act_LoadUnload,@dtStartTime),1,@WorkOrderNo)  --ER0371
					    (@Datatype,@Mc ,@Comp ,@Opn ,@Opr ,Datename(year,@sttime) + '-' + Datename(month,@sttime) + '-' + Datename(day,@sttime),@sttime,Datename(year,@ndtime) + '-' + Datename(month,@ndtime) + '-' +Datename(day,@ndtime),@ndtime,DateDiff(second, @sttime,@ndtime),@Act_LoadUnload ,DateAdd(ms,-(@Act_LoadUnload*1000),@dtStartTime),1,@WorkOrderNo) --ER0371
						---mod 10
						SET @Error = @@ERROR
						IF @Error <> 0 GOTO ERROR_HANDLER_FOR_ALLTYPES
						SET @sttime = @ndtime
					...
					BEGIN
						...
						(@Datatype,@Mc ,@Comp ,@Opn ,@Opr ,Datename(year,@sttime) + '-' + Datename(month,@sttime) + '-' + Datename(day,@sttime),@sttime,Datename(year,@ndtime) + '-' + Datename(month,@ndtime) + '-' +Datename(day,@ndtime),@ndtime,DateDiff(second, @sttime,@ndtime),@Act_LoadUnload ,DateAdd(ms,-(@Act_LoadUnload*1000),@dtStartTime),1,@WorkOrderNo)----dr0119  --ER0371
						---mod 10
						SET @Error = @@ERROR
						IF @Error <> 0 GOTO ERROR_HANDLER_FOR_ALLTYPES
			     			SET @sttime = @ndtime
		   ...
		   If Isdate(@ndtimedown) = 1
		      BEGIN
				...
				BEGIN
					...
					insert into autodata (datatype,mc,comp,opn,opr,dcode,stdate,sttime,nddate,ndtime,cycletime,loadunload,msttime,workordernumber) values
			           	(@Datatype, @Mc , @Comp , @Opn , @Opr ,'NO_DATA' , Datename(year,@ndtimedown) + '-' + Datename(month,@ndtimedown) + '-' + Datename(day,@ndtimedown),@ndtimedown ,Datename(year,@Sttime) + '-' + Datename(month,@Sttime) + '-' + Datename(day,@Sttime) , @Sttime  ,0, @Act_LoadUnload ,@ndtimedown,@WorkOrderNo)
					---mod 10
					...
					insert into autodata (datatype,mc,comp,opn,opr,dcode,stdate,sttime,nddate,ndtime,cycletime,loadunload,msttime,workordernumber) values
			           	(@Datatype, @Mc , @Comp , @Opn , @Opr ,@downcode ,Datename(year,@Sttime) + '-' + Datename(month,@Sttime) + '-' + Datename(day,@Sttime),@Sttime , Datename(year,@Ndtime) + '-' + Datename(month,@Ndtime) + '-' + Datename(day,@Ndtime) ,@Ndtime ,0, @Act_LoadUnload ,@Sttime,@WorkOrderNo)
					---mod 10
				...
				---mod 8
					...
					insert into autodata (datatype,mc,comp,opn,opr,dcode,stdate,sttime,nddate,ndtime,cycletime,loadunload,msttime,workordernumber) values
			           		(@Datatype, @Mc , @Comp , @Opn , @Opr ,@downcode , Datename(year,@ndtimedown) + '-' + Datename(month,@ndtimedown) + '-' + Datename(day,@ndtimedown),@ndtimedown ,Datename(year,@Ndtime) + '-' + Datename(month,@Ndtime) + '-' + Datename(day,@Ndtime) , @Ndtime ,0, @Act_LoadUnload ,@ndtimedown,@WorkOrderNo)
					--mod 10
					SET @Error = @@ERROR
					IF @Error <> 0 GOTO ERROR_HANDLER_FOR_ALLTYPES
				---mod 8
...
--		BEGIN TRANSACTION --DR0324 commented
		...
		Begin --DR0324 Added
			...
			--insert into autodata (datatype,mc,comp,opn,opr,dcode,stdate,sttime,nddate,ndtime,cycletime,loadunload,msttime) values
			insert into autodata_ICD (datatype,mc,comp,opn,opr,dcode,stdate,sttime,nddate,ndtime,cycletime,loadunload) values
			---mod 7(1)
			...
			(42, @Mc , @comp ,@opn , @opr , @downcode , Datename(year,@Sttime) + '-' + Datename(month,@Sttime) + '-' + Datename(day,@Sttime) ,@Sttime , Datename(year,@Ndtime) + '-' + Datename(month,@Ndtime) + '-' + Datename(day,@Ndtime) , @Ndtime ,0,  @Act_LoadUnload)
			---mod 6
...
Declare @Samplesize as int,@Threshold as int
	...
	BEGIN
		...
		IF @BatchID = '0'
		BEGIN
			Insert into SPCAutodata([mc],[comp],[opn],[opr],[Dimension],[Value],[Timestamp],[BatchTS],WearOffSetNumber,MeasureDimension,CorrectionValue,Remarks,InspectionType)
			Select @MC,@COMP,@OPN,@OPR,@splstring3,@SPLSTRING2,@sttime,@sttime,@WearOffSetNumber,@MeasureDimension,@CorrectionValue,@Remarks,@InspectionType
		...
		BEGIN	
			...
			BEGIN
				Insert into SPCAutodata([mc],[comp],[opn],[opr],[Dimension],[Value],[Timestamp],[BatchTS],WearOffSetNumber,MeasureDimension,CorrectionValue,Remarks,InspectionType)
				Select @MC,@COMP,@OPN,@OPR,@splstring3,@SPLSTRING2,@sttime,@BatchTS,@WearOffSetNumber,@MeasureDimension,@CorrectionValue,@Remarks,@InspectionType
...
BEGIN
	   ...
	   BEGIN
			...
			Begin
					BEGIN TRANSACTION
					INSERT INTO AutoDataAlarms (MachineID, AlarmNumber,Alarmtime,RecordType,Target,Actual)
					VALUES( @Mc,@comp,@Sttime,18,@SPLSTRING1,@SPLSTRING2)		
			END
			Else 
			BEGIN
	  				INSERT INTO SmartDataErrorLog(RawdataId,IPAddress,Mc,ErrorMsg,[TimeStamp]) values(@Slno,@IPAddress,@Mc,'SmartData-Duplicate Record Found From machine',getdate())
