/****** Object:  Procedure [dbo].[s_GetCurrentCycleICDRecords]    Committed by VersionSQL https://www.versionsql.com ******/
...
CREATE                  PROCEDURE [dbo].[s_GetCurrentCycleICDRecords]        
 @StartTime datetime,        
 @EndTime datetime,        
...
Else        
Begin        
 SELECT StartTime,EndTime,OperatorID,OperatorName,DownID,DownDescription,DownThreshold,DownTime,Remarks,[id],PDT From #TempCockpitDownData1         
End        
--ER0450        
