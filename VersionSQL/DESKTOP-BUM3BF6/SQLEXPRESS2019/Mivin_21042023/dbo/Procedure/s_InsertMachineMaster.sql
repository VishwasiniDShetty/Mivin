...
BEGIN
	...
	Begin
		...
		BEGIN
			...
			BEGIN
					...
					MachinewiseOwner, CriticalMachineEnabled, DAPEnabled, Lowerpowerthreshold, upperpowerthreshold,  EthernetEnabled, Nto1Device)
			...
			upperpowerthreshold=@upperpowerthreshold, EthernetEnabled=@EthernetEnabled, Nto1Device=@Nto1Device
	...
	BEGIN
		...
		ELSE
		BEGIN
			Update EfficiencyTarget SET AE=@TargetAE, PE=@TargetPE, QE=@TargetQE, OE=@TargetOE
