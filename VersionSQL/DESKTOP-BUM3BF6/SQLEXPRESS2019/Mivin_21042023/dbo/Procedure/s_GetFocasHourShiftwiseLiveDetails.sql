...
--[dbo].[s_GetFocasHourShiftwiseLiveDetails] '2018-10-17','2018-10-17','','','''J500''','','shift'
...
(select Machineid,isnull(sum(Partscount),0) as Parts from  #Totalgetparts where PartsCount>0 group by machineid)T1 inner join #livedetails1 on T1.machineid=#livedetails1.machineid        
