/****** Object:  Procedure [dbo].[s_GetMachinewiseLiveStatus]    Committed by VersionSQL https://www.versionsql.com ******/

--[s_GetMachinewiseLiveStatus] '',''
CREATE PROCEDURE [dbo].[s_GetMachinewiseLiveStatus]
@Plantid nvarchar(50)='',
...
and datatype in(2,42,40,41,1,11,22) group by mc ) t1 on t1.mc=rawdata.mc and t1.slno=rawdata.slno
...
select MachineID,ISNULL(MachineLiveStatus,'NoData') as MachineLiveStatus,ISNULL(MachineLiveStatusColor,'Black') as MachineLiveStatusColor
