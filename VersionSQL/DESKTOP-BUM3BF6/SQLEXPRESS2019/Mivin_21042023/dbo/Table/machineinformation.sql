...
CREATE TABLE [dbo].[machineinformation](
	...
	[FocasEnabled] [bit] NULL,
	[FocasIP] [nvarchar](50) NULL,
	[FocasIPPortNo] [nvarchar](50) NULL,
	[IsTestBenchMachine] [bit] NULL,
...
ALTER TABLE [dbo].[machineinformation] ADD  DEFAULT ((0)) FOR [IsTestBenchMachine]
