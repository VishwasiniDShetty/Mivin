...
ALTER TABLE [dbo].[autodata] ADD  CONSTRAINT [DF_autodata_datatype]  DEFAULT (0) FOR [datatype]
ALTER TABLE [dbo].[autodata] ADD  CONSTRAINT [DF_autodata_loadunload]  DEFAULT (0) FOR [loadunload]
ALTER TABLE [dbo].[autodata] ADD  CONSTRAINT [DF_autodata_compslno]  DEFAULT (0) FOR [compslno]
ALTER TABLE [dbo].[autodata] ADD  CONSTRAINT [DF_autodata_post]  DEFAULT (0) FOR [post]
ALTER TABLE [dbo].[autodata] ADD  CONSTRAINT [DF_AutoData_PartsCount123]  DEFAULT (0) FOR [PartsCount]
